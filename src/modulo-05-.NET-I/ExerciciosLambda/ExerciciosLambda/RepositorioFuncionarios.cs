...
namespace Repositorio
{
    public class RepositorioFuncionarios
    {
        ...
        {
            IList<Funcionario> ListaDeFuncionarios = Funcionarios.Where(Funcionario => Funcionario.Cargo.Equals(cargo)).ToList();
            return ListaDeFuncionarios;
        }

    public IList<Funcionario> OrdenadosPorCargo()
        {
            IList<Funcionario> ListaFuncionariosOrdenados = Funcionarios.OrderBy(Func => Func.Cargo.Titulo).ThenBy(Func => Func.Nome).ToList();
            return (ListaFuncionariosOrdenados);
        }

        public IList<Funcionario> BuscarPorNome(string nome)
        {
            IList<Funcionario> ListaDeFuncionarios = Funcionarios.Where(Funcionario => Funcionario.Nome.Contains(nome)).ToList();
            return ListaDeFuncionarios;
        }
        ...
        {
            var idadePraMenos = idade - 5;
            var idadePraMais = idade + 5;

            IList<Funcionario> ListaDeFuncionarios = Funcionarios.Where(Funcionario => (DateTime.Now.Year - Funcionario.DataNascimento.Year) >= idadePraMenos && (DateTime.Now.Year - Funcionario.DataNascimento.Year) <= idadePraMais).ToList();
            return ListaDeFuncionarios;
        }
        ...
        public double SalarioMedio(TurnoTrabalho? turno = null)
        {
            ...
            if (turno != null)
            {
                IList<Funcionario> ListaDeFuncionarios = Funcionarios.Where(Funcionario => Funcionario.TurnoTrabalho.Equals(turno)).ToList();
                

                MediaSalario = ListaDeFuncionarios.Average(Func => Func.Cargo.Salario);
                return MediaSalario;
            }
            MediaSalario = Funcionarios.Average(Func => Func.Cargo.Salario);
            return MediaSalario;
        }

        public IList<Funcionario> AniversariantesDoMes()
        {
            IList<Funcionario> ListaDeFuncionarios = Funcionarios.Where(Funcionario => Funcionario.DataNascimento.Month.Equals(DateTime.Now.Month)).ToList();
            return ListaDeFuncionarios;
        }
